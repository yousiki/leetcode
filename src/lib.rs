...
#[path = "solutions/check-if-any-element-has-prime-frequency.rs"]
mod check_if_any_element_has_prime_frequency;
...
#[path = "solutions/minimum-increments-to-equalize-leaf-paths.rs"]
mod minimum_increments_to_equalize_leaf_paths;
